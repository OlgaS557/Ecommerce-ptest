...
import SortSizePopup from '../Cart/SortSizePopup';
...
const CartItem = (item:Item) => {
    ...
    const onClickRemove = () => {
        ...
        localStorage.removeItem(`cartItemsColor-${item.id}`);
    }
    ...
    const discountedPrice = item.discount !== null ? ((100 - item?.discount) / 100 * item?.price) * item.count : 0;
                ...
                <div className={styles.info2}>
                    ...
                    <div className={styles.infoQuantity}>
                        ...
                        <div className={styles.countControls}>
                            ...
                            <button onClick={onClickMinus} type='button' className={styles.countDown} disabled={item.count === 1}>
                                <svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
